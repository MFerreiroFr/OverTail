  ...
  new TextObstacle(canvas, this.ctx,canvas.width * 10 + 120, 0, 50, "You are ready now"),
  new TextObstacle(canvas, this.ctx,canvas.width * 10 + 120, 0, 75, "Good luck!"),
  new EndObstacle(canvas, this.ctx, canvas.width * 9 + 50, 398, 0)
    ]