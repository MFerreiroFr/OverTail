function TutorialScreen(name, canvas, changeScreen) {
  ...
  this.elements = {
    ...
    obstacles: [   
      ...
      new TextObstacle(canvas, this.ctx,canvas.width * 11 + 300, 0, 50, "I was born ready \u21e8"),
      new TextObstacle(canvas, this.ctx,canvas.width * 11 + 300, 0, 300, "I need more time \u21e8"),
      new EndObstacle(canvas, this.ctx, canvas.width * 12 + 50, 199, 0, "next"),
